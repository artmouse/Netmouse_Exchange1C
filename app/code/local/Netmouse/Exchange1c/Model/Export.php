...
class Netmouse_Exchange1c_Model_Export extends Mage_ImportExport_Model_Export
{
    ...
    public function processAttributeExport($filter = null)
    {
        ...
        $entityAdapter = Mage::getModel('exchange1c/export_entity_attribute_option');
    ...
    public function processOrderExport($filter = null)
    {
        ...
        $entityAdapter = Mage::getModel('exchange1c/export_entity_order');
    ...
    protected function _getWriter()
    {
        ...
        if (!$this->_writer) {
            $this->_writer = Mage::getModel('exchange1c/export_adapter_array');
                if (! $this->_writer instanceof Netmouse_Exchange1c_Model_Export_Adapter_Abstract) {
                    Mage::throwException(
                        Mage::helper('importexport')->__('Adapter object must be an instance of %s', 'Netmouse_Exchange1c_Model_Export_Adapter_Abstract')
                    );
                }
            }
        return $this->_writer;
