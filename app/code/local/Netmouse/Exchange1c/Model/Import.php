 ...
 * Import Main Model
 *
 * @method Netmouse_Exchange1c_Model_Import setBehavior(string $value)
 * @method string getBehavior()
 * @method Netmouse_Exchange1c_Model_Import setPartialIndexing(boolean $value)
 * @method boolean getPartialIndexing()
 * @method Netmouse_Exchange1c_Model_Import setContinueAfterErrors(boolean $value)
 * @method boolean getContinueAfterErrors()
 * @method Netmouse_Exchange1c_Model_Import setErrorLimit(boolean $value)
 * @method boolean getErrorLimit()
 * @method Netmouse_Exchange1c_Model_Import setUseNestedArrays(boolean $value)
 * @method boolean getUseNestedArrays()
 * @method Netmouse_Exchange1c_Model_Import setIgnoreDuplicates(boolean $value)
 * @method boolean getIgnoreDuplicates()
 * @method Netmouse_Exchange1c_Model_Import setAllowRenameFiles(boolean $value)
 * @method boolean getAllowRenameFiles()
 * @method Netmouse_Exchange1c_Model_Import setDisablePreprocessImageData(boolean $value)
 * @method boolean getDisablePreprocessImageData()
 * @method Netmouse_Exchange1c_Model_Import setUnsetEmptyFields(bool $value)
 * @method string getUnsetEmptyFields()
 * @method Netmouse_Exchange1c_Model_Import setSymbolEmptyFields(string $value)
 * @method string getSymbolEmptyFields()
 */
class Netmouse_Exchange1c_Model_Import extends Mage_ImportExport_Model_Import
{
