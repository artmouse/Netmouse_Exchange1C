 ...
 */
/**
 * @property Netmouse_Exchange1c_Model_Import_Entity_Product $_entityModel
 */
class Netmouse_Exchange1c_Model_Import_Entity_Product_Type_Configurable
    extends Mage_ImportExport_Model_Import_Entity_Product_Type_Configurable
{
    ...
    protected function _getDefaultValue($attrParams)
    {
        switch ($attrParams['code']) {
            ...
            case 'visibility':
            case 'weight':
                $defaultValue = Mage::getStoreConfig('exchange1c/product/' . $attrParams['code']);
