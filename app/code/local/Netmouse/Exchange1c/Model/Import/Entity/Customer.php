 ...
 */
class Netmouse_Exchange1c_Model_Import_Entity_Customer extends Mage_ImportExport_Model_Import_Entity_Customer
{
    /**
    ...
    {
        parent::__construct();
        $this->_addressEntity = Mage::getModel('exchange1c/import_entity_customer_address', $this);
    }
