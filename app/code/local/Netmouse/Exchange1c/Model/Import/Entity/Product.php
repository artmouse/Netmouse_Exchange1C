 ...
 */
class Netmouse_Exchange1c_Model_Import_Entity_Product extends Mage_ImportExport_Model_Import_Entity_Product
{
    /**
     ...
     *
     * @param array $source
     * @return Netmouse_Exchange1c_Model_Import_Entity_Product
     */
    ...
    protected function _initCategories()
    {
        ...
        Mage::dispatchEvent( 'netmouse_exchange1c_entity_product_init_categories', array('transport' => $transportObject) );
    ...
    protected function _reindexUpdatedProducts()
    {
        ...
        Mage::dispatchEvent('exchange1c_reindex_products_before_indexer_stock', array('entity_id' => &$entityIds));
        Mage::getResourceSingleton('cataloginventory/indexer_stock')->catalogProductMassAction($event);

        Mage::dispatchEvent('exchange1c_reindex_products_before_product_indexer_price', array('entity_id' => &$entityIds));
        Mage::getResourceSingleton('catalog/product_indexer_price')->catalogProductMassAction($event);

        Mage::dispatchEvent('exchange1c_reindex_products_before_category_indexer_product', array('entity_id' => &$entityIds));
        Mage::getResourceSingleton('catalog/category_indexer_product')->catalogProductMassAction($event);

        Mage::dispatchEvent('exchange1c_reindex_products_before_product_indexer_eav', array('entity_id' => &$entityIds));
        Mage::getResourceSingleton('catalog/product_indexer_eav')->catalogProductMassAction($event);

        Mage::dispatchEvent('exchange1c_reindex_products_before_fulltext', array('entity_id' => &$entityIds));
        ...
        if (Mage::getResourceModel('ecomdev_urlrewrite/indexer')) {
            Mage::dispatchEvent('exchange1c_reindex_products_before_ecomdev_urlrewrite', array('entity_id' => &$entityIds));
            Mage::getResourceSingleton('ecomdev_urlrewrite/indexer')->updateProductRewrites($entityIds);
        } else {
            Mage::dispatchEvent('exchange1c_reindex_products_before_urlrewrite', array('entity_id' => &$entityIds));
        ...
        Mage::dispatchEvent('exchange1c_reindex_products_before_flat', array('entity_id' => &$entityIds));
        Mage::getSingleton('catalog/product_flat_indexer')->saveProduct($entityIds);

        Mage::dispatchEvent('exchange1c_reindex_products_after', array('entity_id' => &$entityIds));
    ...
    {
        Mage::dispatchEvent('exchange1c_reindex_products_delete_before');
        ...
        Mage::dispatchEvent('exchange1c_reindex_products_delete_after');
    }
     ...
     * Behavior can be turned off with config setting "exchange1c/general/clear_field_on_empty_string"
     * You can define a string which can be used for clearing a field, configured in "exchange1c/product/symbol_for_clear_field"
     *
     * @param array $rowData
     */
